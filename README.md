...
This game consists of 12 pictures of puppies that can be clicked on by the user. After every click the order of the pictures is randomized. The goal of the game is to not click on the same picture more than once per round.

## Running the App

The deployed game can be accessed [here](https://frtime.github.io/calmingClicks/).
